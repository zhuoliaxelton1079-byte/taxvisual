...
4. Preview locally — double-click `index.html` at every page you touched (homepage, `tools/index.html`, `sitemap/index.html`, your new tool page) and confirm it renders and every link resolves.
5. Open a pull request — see [CONTRIBUTING.md](CONTRIBUTING.md). Nobody pushes directly to `main`:
   ...
   ```
6. Once the PR is reviewed and merged, GitHub Pages rebuilds automatically from `main` (usually live within about a minute). Reload `https://taxvisual.com/tools/` to confirm the tool appears, then open its live URL.
